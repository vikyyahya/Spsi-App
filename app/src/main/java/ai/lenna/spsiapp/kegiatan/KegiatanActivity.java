package ai.lenna.spsiapp.kegiatan;
...
public class KegiatanActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(KegiatanActivity.this, HomeActivity.class);
    ...
    private void getDataInformasi(){
        ...
        Call<BeritaResponse> call = service.getkegiatan("Bearer " + Prefs.getString(Constant.TOKEN,""));
